...
struct Constant
{
    static let kSourceKitBrowserFeatureDisableStatusBar: String = "disableStatusBar"
    static let kSourceKitBrowserFeatureScalePagesToFit: String = "scalePagesToFit"
    static let kSourceKitBrowserFeatureSupportInlineMediaPlayback: String = "supportInlineMediaPlayback"
}
...
class SKBrowser2: UIViewController,SourceKitBrowserControlsViewDelegate,UIWebViewDelegate, UIActionSheetDelegate, UIAlertViewDelegate
{
...
//            {
    ...
    func initWithDelegate(delegate: SKBrowserDelegate,  withFeatures p_sourceKitBrowserFeatures: NSArray) -> Any
    {
            delegatee = delegate
