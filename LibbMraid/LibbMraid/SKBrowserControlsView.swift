...
class SKBrowserControlsView: UIView {
    ...
    func initWithSourceKitBrowser(p_skBrowser: SKBrowser2) -> Any?
    {
        ...
        else
        {
            ...
            backButton = UIBarButtonItem(image: backButtonImage,
                                          style: .bordered,
                                          target: self,
            ...
            forwardButton = UIBarButtonItem(image: forwardButtonImage, style: .bordered, target: self, action: #selector(forward))
