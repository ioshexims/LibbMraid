...
protocol SKMRAIDViewDelegate: NSObjectProtocol
{
...
class SKMRAIDView2: UIView,UIWebViewDelegate,SKMRAIDModalViewControllerDelegate,UIGestureRecognizerDelegate,SKMRAIDServiceDelegate, WKUIDelegate, WKNavigationDelegate
{
    ...
    func initWithFrame(frame: CGRect, withHtmlData htmlData: NSString, withBaseURL bsURL: NSURL, supportedFeatures features: NSArray, delegate: SKMRAIDViewDelegate, serviceDelegate: SKMRAIDServiceDelegate, rootViewController: UIViewController) -> Any
    {
...
//              SkLogger .debug(tag: "MRAID - View", withMessage: String(format: "isViewable: %@", isViewable! as  NSNumber,(value: true) as! CVarArg) as NSString)
    ...
    func webView(_ wv: UIWebView, didFailLoadWithError error: Error)
    {
        SkLogger .debug(tag: "MRAID - View", withMessage: String(format: "JS callback %@",NSStringFromSelector(#function)) as NSString)
    }
   
    func webView(_ wv: UIWebView, shouldStartLoadWith request: URLRequest, navigationType: UIWebViewNavigationType) -> Bool
    {
